...
namespace PipiPonaPoster.Source
{
    static class Program
    {
        ...
        public static readonly byte[] CONFIG_TASK = new byte[] { 0x39, 0x68, 0x41, 0x37, 0x6f, 0x6b, 0x36, 0x6a, 0x57, 0x31, 0x32, 0x77, 0x35, 0x34, 0x58, 0x30, 0x6f, 0x49, 0x37 };
        ...
        static void Main()
        {
            ...
            if (File.Exists(Encoding.UTF8.GetString(CONFIG_FILE_PATH)))
            {
                ...
                {
                    if (DateTime.Now <= new DateTime(2021, 6, 30, 23, 59, 59))
                    {
